...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The PersonQueue Enqueue method always add items at the begining of the list
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Cannot handle players with infinite turns (zero or less turns).
    ...
    // Defect(s) Found: Cannot handle players with infinite turns (less than zero).
    ...
    // Defect(s) Found: No actual deffect found just checks how it handles Errors when Empty
